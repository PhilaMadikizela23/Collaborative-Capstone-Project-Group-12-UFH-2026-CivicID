...
class SmartIdOverviewScreen extends StatelessWidget {
  final GovernmentService service;

  const SmartIdOverviewScreen({
    super.key,
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                _pictureCard(
                  'assets/images/civicid_smart_id_overview.png',
                ),
                ...
                _sectionCard(
                  ...
                  child: Column(
                    children: [
                      ...
                      _checkItem('Make sure the information on your documents matches your profile.'),
                    ],
                  ),
                ),
                ...
                _stepsCard(
                  const [
                    'Choose Smart ID application type',
                ...
                const SizedBox(height: 18),
                _tipCard(
                  'Have your information and documents ready before you begin. '
                      'This can make the application process easier to complete.',
                ),
